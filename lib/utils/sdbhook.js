...
SdbHook.prototype.linkDebugSymbols = function(sourcePath, contractName, address, compilationResult) {
  var self = this;
  ...
  self.compilationResult.contractMap[cleanedAddress] = sourcePath + ":" + contractName;
